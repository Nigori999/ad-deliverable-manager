...
public static class PermissionCatalog
{
    ...
    public const string ChangeVersionCreate = "CHANGE_VERSION_CREATE";
    ...
    [
        ...
        (VersionView,"查看版本","交付物台账"),(VersionCreate,"新增版本","交付物台账"),(VersionSubmit,"提交版本审批","交付物台账"),(VersionReturn,"退回版本修改","交付物台账"),(VersionApprove,"版本审批通过","交付物台账"),(VersionRelease,"版本正式发布","交付物台账"),(VersionDeprecate,"废止版本","交付物台账"),
        (RelationView,"查看关联关系","交付物台账"),(RelationCreate,"建立关联关系","交付物台账"),(RelationDelete,"删除关联关系","交付物台账"),
        (BaselineView,"查看产品基线","产品基线"),(BaselineCreate,"新增产品基线","产品基线"),(BaselineEdit,"编辑产品基线草稿","产品基线"),(BaselinePublish,"发布产品基线","产品基线"),(BaselineCopy,"复制产品基线","产品基线"),(BaselineChange,"变更产品基线","产品基线"),
        (ChangeView,"查看变更","变更管理"),(ChangeCreate,"发起变更","变更管理"),(ChangeExport,"导出变更","变更管理"),(ChangeApprove,"批准变更","变更管理"),(ChangeReject,"驳回变更","变更管理"),(ChangeStart,"开始实施变更","变更管理"),(ChangeVersionCreate,"创建变更版本","变更管理"),(ChangeVerify,"提交变更验证","变更管理"),(ChangeClose,"关闭变更","变更管理"),
        (DashboardView,"查看仪表盘","概览分析"),(AnalyticsView,"查看完整度分析","概览分析"),
        (MasterDataView,"查看基础数据","系统管理"),(MasterDataCreate,"新增基础数据","系统管理"),(MasterDataEdit,"编辑基础数据","系统管理"),(MasterDataDelete,"删除基础数据","系统管理"),(UserView,"查看用户","系统管理"),(UserCreate,"新增用户","系统管理"),(UserEdit,"编辑用户","系统管理"),(UserResetPassword,"重置用户密码","系统管理"),(RoleView,"查看角色","系统管理"),(RoleCreate,"新增角色","系统管理"),(RoleEdit,"编辑角色","系统管理"),(RolePermissionEdit,"配置角色权限","系统管理"),(RoleDelete,"删除角色","系统管理"),(SystemBackup,"数据库备份","系统管理"),(AuditView,"查看审计日志","系统管理")
    ];
}
